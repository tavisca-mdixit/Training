...
namespace RollBasedAccess.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            var response = creds.CheckCreds(creds);

            if (ModelState.IsValid && response.ResponseStatus.Code == "200")
            {
                CreateAuthenticationTicket(response.AuthenticatedEmployee);


                TempData["EmpId"] = response.AuthenticatedEmployee.Id;
                ViewData["EmpId"] = response.AuthenticatedEmployee.Id;
                ViewBag.EmpId = response.AuthenticatedEmployee.Id;
                returnUrl = @"HR\Index";
        ...
        public ActionResult Manage(LocalPasswordModel model)
        {
            ...
            passObj.OldPassword = model.OldPassword;
            passObj.NewPassword = model.NewPassword;
            passObj.EmployeeId = (string)TempData["EmpId"];
        ...
        public void CreateAuthenticationTicket(Employee employee)
        {
            ...
            serializeModel.Title = employee.Title;
            serializeModel.FirstName = employee.FirstName;
            serializeModel.LastName = employee.LastName;

            JavaScriptSerializer serializer = new JavaScriptSerializer();
            string userData = serializer.Serialize(serializeModel);
            FormsAuthenticationTicket authTicket = new FormsAuthenticationTicket(1, employee.Id, DateTime.Now, DateTime.Now.AddHours(8), false, userData);
