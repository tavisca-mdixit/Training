...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button  ID="Button1" runat="server" Text="Logout" OnClick="Button1_Click" BackColor="Black" ForeColor="White" Width="104px" />
        ...
        <div class="tab tab-pane " id="password">
         ...
         <asp:Button ID="ChangePasswordBtn" runat="server" Text="Change Password" OnClick="EmpChangePassword" BackColor="Black" Font-Italic="False" Font-Names="Arial" ForeColor="White" Height="30px" Width="113px"/>       <asp:Label ID="Message" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="#003300"></asp:Label>
