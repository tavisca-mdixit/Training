<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeePasswordChnage.aspx.cs" Inherits="WebApplication1.WebForm3" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="Button1" runat="server" Text="Change Password" OnClick="EmpChangePassword" BackColor="Black" Font-Italic="True" Font-Names="Myanmar Text" ForeColor="White" Height="35px" Width="156px"/>
